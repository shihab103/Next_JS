      ...
      <section className="bg-pink-100 dark:bg-pink-900 py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg max-w-2xl mx-auto">
            ...
            dedicated team ensures quality, reliability, and excellence in
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="flex flex-col justify-center">
            ...
            <p className="text-base-content text-lg">
              To deliver exceptional services that empower businesses to
              achieve their goals efficiently and effectively, while
